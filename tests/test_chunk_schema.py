...
# # Este archivo de prueba está actualmente deshabilitado porque el archivo de datos
# # 'dataset/chunks_enriched/chunks_enriched_v1.0.jsonl' no existe en el repositorio.
# # Los tests se reactivarán una vez que se proporcione un archivo de datos de muestra.
...
# #         pytest.skip("Archivo de datos de chunks no encontrado, omitiendo tests.")
